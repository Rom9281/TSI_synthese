...
/*****************************************************************************\
 * Chargement d'une texture (seules les textures tga sont supportes)                                                            *
 \*****************************************************************************/
static int load_texture(std::string filename)
{
  GLuint texture_id;
...
static void init()
{
  ...
  texture_id = load_texture("data/unicorn.tga");
  glBindTexture(GL_TEXTURE_2D, texture_id); CHECK_GL_ERROR();
...
static void display_callback()
{
  ...
  glUniform4f(loc_translation, -1.0f, -1.0f, -3.0f, 0.0f);                        CHECK_GL_ERROR();
