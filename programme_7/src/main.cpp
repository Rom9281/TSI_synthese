...
static void init()
{
  ...
  //Fait par Maxime : à vérifier
  // Active l'utilisation des données de couleur (le 2 correspond à la location dans le vertex shader)
  ...
  shader_program_id = glhelper::create_program_from_file(
      "programme_7/src/shader.vert", 
      "programme_7/src/shader.frag"); CHECK_GL_ERROR();
